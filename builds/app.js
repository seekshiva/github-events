...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventStreamFetcher = __webpack_require__(120);

	var _eventStreamFetcher2 = _interopRequireDefault(_eventStreamFetcher);

	var _repoSelector = __webpack_require__(126);

	var _repoSelector2 = _interopRequireDefault(_repoSelector);
	...
	function main(drivers) {
	  var eventTypeStream = drivers.DOM.select('select#eventTYpe').events('change').map(function (ev) {
	    return ev.target.value;
	  }).startWith(defaultState.eventType);

	  var repoStream = drivers.DOM.select('select#repo').events('change').map(function (ev) {
	    return ev.target.value;
	  }).startWith(defaultState.repo);

	  var eventsStream = (0, _eventStreamFetcher2.default)(eventTypeStream, repoStream);

	  return {
	    DOM: eventsStream.map(function (eventListing) {
	      return (0, _dom.h)('div', [(0, _dom.h)('h1', 'GitHub Events'), (0, _dom.h)('select', { id: 'eventTYpe' }, [(0, _dom.h)('option', {
	        value: 'all',
	        selected: defaultState.eventType === 'all'
	      }, 'All Events'), (0, _dom.h)('option', {
	        value: 'issues',
	        selected: defaultState.eventType === 'issues'
	      }, 'Issues')]), (0, _repoSelector2.default)().DOM, eventListing.DOM]);
	    })
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mockDOMResponse = __webpack_require__(119);
...
/***/ function(module, exports, __webpack_require__) {
	...
	try {
	  matchesSelector = __webpack_require__(105);
	} catch (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Map = Map || __webpack_require__(49); // eslint-disable-line no-native-reassign
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(50)() ? Map : __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isString       = __webpack_require__(84)
	  , iteratorSymbol = __webpack_require__(85).iterator
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isString = __webpack_require__(84)
	  ...
	  , StringIterator = __webpack_require__(99)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(102)('key',
		'value', 'key+value');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rx = __webpack_require__(2);
	var toHTML = __webpack_require__(107);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var paramCase = __webpack_require__(110);
	var createAttribute = __webpack_require__(116);
	var voidElements = __webpack_require__(118);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sentenceCase = __webpack_require__(111)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var lowerCase = __webpack_require__(112)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var escape = __webpack_require__(108);
	var propConfig = __webpack_require__(117);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = eventStreamFetcher;
	...
	var _repoEvents = __webpack_require__(121);

	var _repoEvents2 = _interopRequireDefault(_repoEvents);

	var _issueEvents = __webpack_require__(124);

	var _issueEvents2 = _interopRequireDefault(_issueEvents);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function eventStreamFetcher(eventTypeStream, repoStream) {
	  var reqUrlStream = _rx2.default.Observable.combineLatest(eventTypeStream, repoStream).map(function (_ref) {
	    var _ref2 = _slicedToArray(_ref, 2);

	    var eventType = _ref2[0];
	    var repoPath = _ref2[1];

	    var suffix = eventType === 'issues' ? '/issues/comments?sort=created&direction=desc' : '/events';

	    return 'https://api.github.com/repos/' + repoPath + suffix;
	  });
	  var responseStream = reqUrlStream.flatMapLatest(function (url) {
	    return fetch(url);
	  });

	  var baseEventsStream = responseStream.flatMap(function (response) {
	    return response.json();
	  }).shareReplay(1);

	  var eventsStream = baseEventsStream.startWith([]);

	  var lastFetchedEventStream = eventsStream.withLatestFrom(eventTypeStream).map(function (_ref3) {
	    var _ref4 = _slicedToArray(_ref3, 2);

	    var eventType = _ref4[1];
	    return eventType;
	  }).shareReplay(1);

	  var repoEventsStream = (0, _repoEvents2.default)({ eventsStream: eventsStream });
	  var issueEventsStream = (0, _issueEvents2.default)({ eventsStream: eventsStream });
	  lastFetchedEventStream.subscribe(function () {});

	  var loadingStatusStream = reqUrlStream.map(function () {
	    return 1;
	  }).merge(baseEventsStream.map(function () {
	    return 0;
	  }));

	  return loadingStatusStream.combineLatest(lastFetchedEventStream).map(function (_ref5) {
	    var _ref6 = _slicedToArray(_ref5, 2);

	    var isLoading = _ref6[0];
	    var latestEventType = _ref6[1];

	    return {
	      DOM: (0, _dom.h)('div', [(0, _dom.h)('div', {
	        innerHTML: isLoading ? 'Loading...' : '&nbsp;'
	      }), latestEventType === 'all' ? (0, _dom.h)('div', repoEventsStream.DOM) : (0, _dom.h)('div', issueEventsStream.DOM)])
	    };
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _showEvent = __webpack_require__(122);

	var _showEvent2 = _interopRequireDefault(_showEvent);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function repoEvents(_ref) {
	  var eventsStream = _ref.eventsStream;

	  return {
	    DOM: eventsStream.map(function (events) {
	      return (0, _dom.h)('div', [(0, _dom.h)('h1', events.length === 0 ? 'Loading...' : '' + events.length + ' events'), (0, _dom.h)('ul', events.map(_showEvent2.default))]);
	    })
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _marked = __webpack_require__(123);
	...
	function watchEvent(event) {
	  ...
	  return (0, _dom.h)('div', [(0, _dom.h)('a', { href: actor.url }, actor.login),
	...
	function pushEvent(event) {
	  ...
	  return (0, _dom.h)('div', [(0, _dom.h)('a', { href: actor.url }, actor.login),
	  //TODO started or stopped?
	  ' pushed ' + commits.length + ' commits:', (0, _dom.h)('ul', commits.map(function (commit) {
	    return (0, _dom.h)('li', [commit.message + ' - ', (0, _dom.h)('a', { href: commit.author.email }, commit.author.name)]);
	  }))]);
	}
	...
	function gollumEvent(event) {
	  ...
	  return (0, _dom.h)('div', [(0, _dom.h)('a', { href: actor.url }, actor.login), ' has updated the wiki:', (0, _dom.h)('ul', [pages.map(function (page) {
	    return (0, _dom.h)('li', [page.action + ' ', (0, _dom.h)('a', { href: page.html_url }, page.title)]);
	  })])]);
	}
	...
	function pullRequestEvent(event) {
	  ...
	  return (0, _dom.h)('div', [(0, _dom.h)('div', [(0, _dom.h)('h3', [(0, _dom.h)('a', { href: PR.html_url }, '#' + PR.number), ' - ' + PR.title])]), (0, _dom.h)('a', { href: actor.url }, actor.login), ' ' + payload.action + ' a pull request ', (0, _dom.h)('br'), (0, _dom.h)('br')]);
	}
	...
	function issueCommentEvent(event) {
	  ...
	  return (0, _dom.h)('div', [(0, _dom.h)('div', [(0, _dom.h)('h3', [(0, _dom.h)('a', { href: issue.html_url }, '#' + issue.number), ' - ' + issue.title])]), (0, _dom.h)('a', { href: actor.url }, actor.login), ' commented on an issue.', (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('div', { innerHTML: (0, _marked2.default)(comment.body) }), (0, _dom.h)('br')]);
	}

	function dummyEvent(event) {
	  return (0, _dom.h)('span', event.type);
	}
	...
	function showEvent(event) {
	  ...
	  return (0, _dom.h)('li', eventHandler(event));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = issueEvents;

	var _dom = __webpack_require__(5);

	var _issueComments = __webpack_require__(125);

	var _issueComments2 = _interopRequireDefault(_issueComments);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function issueEvents(_ref) {
	  var issuesStream = _ref.eventsStream;

	  return {
	    DOM: issuesStream.map(function (issues) {
	      return (0, _dom.h)('div', [(0, _dom.h)('h1', issues.length === 0 && 'Loading...'), (0, _dom.h)('ul', issues.map(_issueComments2.default))]);
	    })
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = showIssueEvent;
	...
	function showIssueEvent(issue) {
	  var issue_url = issue.issue_url;
	  var user = issue.user;

	  var issueNumber = issue_url.split('/').reverse()[0];

	  return (0, _dom.h)('li', [(0, _dom.h)('a', { href: user.url }, user.login), ' commented on ', (0, _dom.h)('a', { href: issue.html_url }, '#' + issueNumber), (0, _dom.h)('p', { innerHTML: (0, _marked2.default)(issue.body) })]);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function repoSelector() {
	  var defaultRepo = 'facebook/react';
	  var repoListStream = _rx2.default.Observable.just(['facebook/react', 'cyclejs/cycle-core', 'cyclejs/cycle-dom', 'seekshiva/courses']);
	  return {
	    DOM: repoListStream.map(function (repoList) {
	      return (0, _dom.h)('select', { id: 'repo' }, repoList.map(function (repo) {
	        return (0, _dom.h)('option', {
